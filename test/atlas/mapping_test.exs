defmodule Atlas.MappingTest do
  ...
  describe "destinations" do
    ...
    test "list_filtered_destinations/7 returns one spring destination" do
    ...
    test "list_filtered_destinations/7 returns one summer destination" do
    ...
    test "list_filtered_destinations/7 returns one fall destination" do
    ...
    test "list_filtered_destinations/7 returns one winter destination" do
    ...
    test "list_filtered_destinations/7 returns one ice destination" do
    ...
    test "list_filtered_destinations/7 returns two lake destinations" do
    ...
    test "list_filtered_destinations/7 returns two river & stream destinations" do
    ...
    test "list_filtered_destinations/7 returns two 'less than one hour' destinations" do
    ...
    test "list_filtered_destinations/7 returns two 'one to three hour' destinations" do
    ...
    test "list_filtered_destinations/7 returns two 'more than three hour' destinations" do
    ...
    test "list_filtered_destinations/7 returns two 'car_friendly - true' destinations" do
    ...
    test "list_filtered_destinations/7 returns two 'car_friendly - false' destinations" do
      custom_multi_destination_fixture(@valid_multi_attrs, :car_friendly, [
        true,
        false,
        false
    ...
    test "list_filtered_destinations/7 returns two 'off leash' destinations" do
      ...
      assert Enum.count(Mapping.list_filtered_destinations("", "", "", "", "off_leash", "", "")) ==
               2
    end

    test "list_filtered_destinations/7 returns two 'on leash' destinations" do
      custom_multi_destination_fixture(@valid_multi_attrs, :dogs_off_leash, [
        true,
        false,
        false
      ...
      assert Enum.count(Mapping.list_filtered_destinations("", "", "", "", "on_leash", "", "")) ==
               2
    end

    test "list_filtered_destinations/7 returns two 'no_dog' destinations" do
    ...
    test "list_filtered_destinations/7 returns two 'hike in' destinations" do
    ...
    test "list_filtered_destinations/7 returns two 'non-hike in' destinations" do
      custom_multi_destination_fixture(@valid_multi_attrs, :hike_in, [
        true,
        false,
        false
    ...
    test "list_filtered_destinations/7 returns three 'car or backpack camp' destinations" do
      standard_multi_destination_fixture(@valid_multi_attrs)
    ...
    test "list_filtered_destinations/7 returns two 'car camp' destinations" do
      ...
      assert Enum.count(Mapping.list_filtered_destinations("", "", "", "", "", "", "car")) == 2
    end

    test "list_filtered_destinations/7 returns two 'backpack camp' destinations" do
      ...
      assert Enum.count(Mapping.list_filtered_destinations("", "", "", "", "", "", "backpack")) ==
               2
    end
