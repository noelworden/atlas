defmodule Atlas.MappingTest do
  ...
  describe "destinations" do
    ...
    test "returns all unfiltered destinations" do
      ...
      assert Enum.count(Mapping.list_filtered_destinations("none", "", "", "", "", "", "", "")) ==
               3
    end

    test "list_filtered_destinations/8 returns one spring destination" do
      custom_multi_destination_fixture(@valid_multi_attrs, :season_spring, [true, false, false])

      assert Enum.count(Mapping.list_filtered_destinations("spring", "", "", "", "", "", "", "")) ==
               1
    end

    test "list_filtered_destinations/8 returns one summer destination" do
      custom_multi_destination_fixture(@valid_multi_attrs, :season_summer, [true, false, false])

      assert Enum.count(Mapping.list_filtered_destinations("summer", "", "", "", "", "", "", "")) ==
               1
    end

    test "list_filtered_destinations/8 returns one fall destination" do
      custom_multi_destination_fixture(@valid_multi_attrs, :season_fall, [true, false, false])

      assert Enum.count(Mapping.list_filtered_destinations("fall", "", "", "", "", "", "", "")) ==
               1
    end

    test "list_filtered_destinations/8 returns one winter destination" do
      custom_multi_destination_fixture(@valid_multi_attrs, :season_winter, [true, false, false])

      assert Enum.count(Mapping.list_filtered_destinations("winter", "", "", "", "", "", "", "")) ==
               1
    end

    test "list_filtered_destinations/8 returns one ice destination" do
      custom_multi_destination_fixture(@valid_multi_attrs, :ice_fishing, [true, false, false])

      assert Enum.count(Mapping.list_filtered_destinations("ice", "", "", "", "", "", "", "")) ==
               1
    end

    test "list_filtered_destinations/8 returns two lake destinations" do
    ...
    test "list_filtered_destinations/8 returns two river & stream destinations" do
      custom_multi_destination_fixture(@valid_multi_attrs, :lake, [true, false, false])

      assert Enum.count(Mapping.list_filtered_destinations("", false, "", "", "", "", "", "")) ==
               2
    end

    test "list_filtered_destinations/8 returns two 'less than one hour' destinations" do
      ...
      assert Enum.count(
               Mapping.list_filtered_destinations("", "", "less_than_one", "", "", "", "", "")
             ) ==
               2
    end

    test "list_filtered_destinations/8 returns two 'one to three hour' destinations" do
      ...
      assert Enum.count(
               Mapping.list_filtered_destinations("", "", "one_to_three", "", "", "", "", "")
             ) ==
               2
    end

    test "list_filtered_destinations/8 returns two 'more than three hour' destinations" do
      ...
      assert Enum.count(
               Mapping.list_filtered_destinations("", "", "more_than_three", "", "", "", "", "")
             ) ==
               2
    end

    test "list_filtered_destinations/8 returns two 'car_friendly - true' destinations" do
    ...
    test "list_filtered_destinations/8 returns two 'car_friendly - false' destinations" do
      custom_multi_destination_fixture(@valid_multi_attrs, :car_friendly, [
        true,
        false,
        false
    ...
    test "list_filtered_destinations/8 returns two 'off leash' destinations" do
      ...
      assert Enum.count(
               Mapping.list_filtered_destinations("", "", "", "", "off_leash", "", "", "")
             ) ==
               2
    end

    test "list_filtered_destinations/8 returns two 'on leash' destinations" do
      custom_multi_destination_fixture(@valid_multi_attrs, :dogs_off_leash, [
        true,
        false,
        false
      ...
      assert Enum.count(
               Mapping.list_filtered_destinations("", "", "", "", "on_leash", "", "", "")
             ) ==
               2
    end

    test "list_filtered_destinations/8 returns two 'no_dog' destinations" do
      ...
      assert Enum.count(Mapping.list_filtered_destinations("", "", "", "", "no_dog", "", "", "")) ==
               2
    end

    test "list_filtered_destinations/8 returns two 'hike in' destinations" do
    ...
    test "list_filtered_destinations/8 returns two 'non-hike in' destinations" do
      custom_multi_destination_fixture(@valid_multi_attrs, :hike_in, [
        true,
        false,
        false
    ...
    test "list_filtered_destinations/8 returns three 'car or backpack camp' destinations" do
      standard_multi_destination_fixture(@valid_multi_attrs)

      assert Enum.count(
               Mapping.list_filtered_destinations("", "", "", "", "", "", "car_backpack", "")
             ) == 3
    end

    test "list_filtered_destinations/8 returns two 'car camp' destinations" do
      custom_multi_destination_fixture(@valid_multi_attrs, :car_camp, [
        true,
        true,
        false
      ])

      assert Enum.count(Mapping.list_filtered_destinations("", "", "", "", "", "", "car", "")) ==
               2
    end

    test "list_filtered_destinations/8 returns two 'backpack camp' destinations" do
      custom_multi_destination_fixture(@valid_multi_attrs, :backpack_camp, [
        true,
        true,
        false
      ])
      ...
      assert Enum.count(
               Mapping.list_filtered_destinations("", "", "", "", "", "", "backpack", "")
             ) ==
               2
    end

    test "list_filtered_destinations/8 returns two 'no fee' destinations" do
      custom_multi_destination_fixture(@valid_multi_attrs, :fee, [
        true,
        false,
        false
      ])
